...
class SupConResNet(nn.Module):
    ...
    def __init__(self, name='resnet18', head='mlp', num_classes=10, feat_dim=128):
    ...
    def gram_feature_list(self,x):
        return self.encoder.gram_feature_list(x)

    def get_min_max(self, data, power):
        return self.encoder.get_min_max(data, power)

    def get_deviations(self,data,power,mins,maxs):
        return self.encoder.get_deviations(data,power,mins,maxs)
