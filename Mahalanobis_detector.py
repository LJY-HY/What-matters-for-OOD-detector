...
# import sys
# sys.stdout = open('Mahalanobis_output.txt','a')
...
def main():
    ...
    if args.tuning_strategy is not 'Original':
        out_dist_list_strategy = [args.tuning_strategy]
        ...
        for magnitude in m_list:
            ...
            for out_dist in out_dist_list_strategy:
        ...
        for out in out_dist_list_strategy:
        ...
        for in_list in list_best_results:
            ...
            for results in in_list:
                print('out_distribution: '+ out_dist_list_strategy[int(count_out)]+'\n')
                for mtype in mtypes:
